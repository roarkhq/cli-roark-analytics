  ...
  },
  {
    ...
    flags: [
      ...
      },
      {
        ...
        required: false,
        description:
          'Controls how quickly the persona responds to pauses in conversation (QUICK, NORMAL, RELAXED). BARGE_IN also talks over the agent once it has held the floor for several seconds.',
        valueKind: 'string',
