...
export const GROUPS: Readonly<Record<string, string>> = {
  ...
  'agent-config': 'Manage agent configs',
  'agent-config staging': 'Manage agent config staging',
  autoimprove: 'Manage autoimproves',
  'autoimprove job': 'Manage autoimprove jobs',
  'autoimprove job guidance': 'Read autoimprove job guidance',
  ...
  'call tool-invocation': 'Manage call tool invocations',
  ...
  'metric variant': 'Manage metric variants',
  simulation: 'Manage simulations',
  'simulation environment': 'Manage simulation environments',
  'simulation job': 'Read simulation jobs',
  'simulation job tool-mock': 'Read simulation job tool mocks',
  ...
  'simulation template': 'Read simulation templates',
  'simulation tool': 'Read simulation tool',
  'simulation tool-fixture': 'Manage simulation tool fixtures',
...
export const COMMANDS: readonly CliCommand[] = [
  ...
  {
    commandPath: ['agent', 'prompt', 'version', 'list'],
    clientProperty: 'agentPrompt',
    methodName: 'listVersions',
    httpMethod: 'get',
    httpPath: '/v1/agent/{agentId}/prompts/{promptId}/versions',
    summary: "List a prompt's versions",
    description: 'Returns the full version history of a single prompt lineage, newest first.',
    positionals: [
      {
        name: 'agent-id',
        paramKey: 'agentId',
  ...
  {
    commandPath: ['agent-config', 'get'],
    clientProperty: 'agentConfig',
    methodName: 'getByID',
    httpMethod: 'get',
  ...
  {
    commandPath: ['agent-config', 'promote'],
    clientProperty: 'agentConfig',
    methodName: 'promote',
    httpMethod: 'post',
  ...
  {
    commandPath: ['agent-config', 'resolve'],
    clientProperty: 'agentConfig',
    methodName: 'resolve',
    httpMethod: 'post',
    ...
    description:
      'The call your agent makes at session start. Returns the config JSON for this session, with per-session simulation recognition built in: when the session was originated by a Roark simulation (matched by caller number against the calls Roark has in flight), the STAGING revision is served for that session only, so Autoimprove candidates are tested on your real deployment. Real traffic always resolves to production; any recognition miss degrades to production too. On the first fetch of an unknown key, pass `defaults` (your baked-in config): the key is registered and the defaults become revision 1. That makes integration a single call. Cache the response per session; do not fetch per turn.',
    positionals: [
      {
        name: 'key',
        paramKey: 'key',
    ...
    flags: [
      ...
      {
        name: 'session.caller-number',
        path: ['session', 'callerNumber'],
        location: 'body',
        required: false,
        description: 'The number calling your agent (E.164). Required for simulation recognition.',
        valueKind: 'string',
        repeatable: false,
      },
      {
        name: 'session.called-number',
        path: ['session', 'calledNumber'],
        location: 'body',
        required: false,
  ...
  {
    commandPath: ['agent-config', 'staging', 'delete'],
    clientProperty: 'agentConfig',
  ...
  {
    commandPath: ['agent-config', 'update'],
    clientProperty: 'agentConfig',
    methodName: 'update',
    httpMethod: 'put',
    httpPath: '/v1/agent-config/{key}',
    ...
    flags: [
      {
        ...
        location: 'body',
        required: true,
        description: 'Which channel to write.',
        valueKind: 'string',
      ...
      },
      {
        ...
        location: 'body',
        required: true,
        description: 'The full config JSON for the new revision.',
        valueKind: 'object',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'One-line story of the change.',
        valueKind: 'string',
        repeatable: false,
      },
      {
  ...
  {
    commandPath: ['autoimprove', 'job', 'answer'],
    clientProperty: 'autoimproveJob',
    methodName: 'answerQuestion',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job/{jobId}/answer',
    summary: "Answer Roark's question",
    description:
      'Answer the question a job is blocked on. Only meaningful while the job status is NEEDS_INPUT (the open QUESTION entry carries the offered options; free text is also accepted). Otherwise returns a conflict.',
    positionals: [
      {
        name: 'job-id',
        paramKey: 'jobId',
    ...
    flags: [
      {
        ...
        location: 'body',
        required: true,
        description: 'The message for Roark.',
        valueKind: 'string',
        repeatable: false,
      },
    ],
  ...
  {
    commandPath: ['autoimprove', 'job', 'cancel'],
    clientProperty: 'autoimproveJob',
    methodName: 'cancel',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job/{jobId}/cancel',
    summary: 'Cancel a job',
    description:
      'Stop a live job. Production is never changed by a cancel; everything the job set up (the shadow agent, its phone number, authored test flows and run plan) is cleaned up automatically.',
    positionals: [
      {
        name: 'job-id',
        paramKey: 'jobId',
  ...
  {
    commandPath: ['autoimprove', 'job', 'create'],
    clientProperty: 'autoimproveJob',
    methodName: 'create',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job',
    summary: 'Start an Autoimprove job',
    description:
      'Commission Roark on an objective. It clones the agent into a staging shadow (or uses your designated staging agent), authors a validation suite of simulated callers, measures a baseline, changes the staging configuration, and re-tests until the objective metric passes its target. Production is never touched by the loop; verified changes wait for promotion. Requires an active provider integration (Vapi, Retell, or ElevenLabs) with agent config writes enabled. One live job per agent: starting a second returns a conflict. The job runs asynchronously; poll GET /v1/autoimprove/job/{jobId} or watch it in the dashboard. When its status is NEEDS_INPUT, answer via the answer endpoint; when AWAITING_PROMOTE, promote or dismiss.',
    positionals: [],
    flags: [
      {
        name: 'agent-id',
        ...
        location: 'body',
        required: true,
        description: 'The production agent to improve. It is never modified until you promote.',
        valueKind: 'string',
        repeatable: false,
      },
      {
        name: 'objective-metric-definition-id',
        path: ['objectiveMetricDefinitionId'],
        location: 'body',
        required: true,
        description:
      ...
      },
      {
        ...
        location: 'body',
        required: true,
        description: 'Human-readable label for the objective, shown everywhere the job appears.',
        valueKind: 'string',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'The pass-rate percentage that counts as fixed. Defaults to 90.',
        valueKind: 'number',
        repeatable: false,
      },
      {
        name: 'staging-agent-id',
        path: ['stagingAgentId'],
        location: 'body',
        required: false,
        description:
      ...
      {
        name: 'customer-integration-id',
        path: ['customerIntegrationId'],
        location: 'body',
        required: false,
        description:
      ...
      {
        name: 'validation-run-plan-id',
        path: ['validationRunPlanId'],
        location: 'body',
        required: false,
        description:
      ...
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Cap on decision turns. Defaults to 50.',
        valueKind: 'integer',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Cap on simulated calls dialed. Defaults to 200.',
        valueKind: 'integer',
        repeatable: false,
      },
    ],
  ...
  {
    commandPath: ['autoimprove', 'job', 'dismiss'],
    clientProperty: 'autoimproveJob',
    methodName: 'dismiss',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job/{jobId}/dismiss',
    summary: 'Dismiss a verified job',
    description:
  ...
  {
    commandPath: ['autoimprove', 'job', 'get'],
    clientProperty: 'autoimproveJob',
    methodName: 'getByID',
    httpMethod: 'get',
    httpPath: '/v1/autoimprove/job/{jobId}',
    summary: 'Get an Autoimprove job',
    description:
  ...
  {
    commandPath: ['autoimprove', 'job', 'guidance', 'send'],
    clientProperty: 'autoimproveJob',
    methodName: 'sendGuidance',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job/{jobId}/guidance',
    summary: 'Send guidance to a running job',
    description:
      'Steer Roark mid-job. The message is folded into its next decision and is binding. Accepted while the job is live (RUNNING, NEEDS_INPUT, or PAUSED); a concluded job returns a conflict.',
    positionals: [
      {
        name: 'job-id',
        paramKey: 'jobId',
  ...
  {
    commandPath: ['autoimprove', 'job', 'list'],
    clientProperty: 'autoimproveJob',
    methodName: 'list',
    httpMethod: 'get',
    httpPath: '/v1/autoimprove/job',
    ...
    description:
      'List the Autoimprove jobs in this project, most recent first, capped at 100. A job is one autonomous engagement: Roark improving one agent toward one objective metric on a staging copy, with a human-gated promote to production at the end.',
    positionals: [],
    flags: [],
    hasParams: false,
    paramsAllOptional: true,
  ...
  {
    commandPath: ['autoimprove', 'job', 'promote'],
    clientProperty: 'autoimproveJob',
    methodName: 'promote',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job/{jobId}/promote',
    summary: 'Promote a verified job to production',
    description:
      'Apply the verified staging changes to the PRODUCTION agent. Only a job in AWAITING_PROMOTE can be promoted. A snapshot of the production configuration is taken immediately before the write, so the promote is fully rollbackable. After the promote the staging shadow and its phone number are cleaned up.',
    positionals: [
      {
        name: 'job-id',
        paramKey: 'jobId',
  ...
  },
  {
    ...
    description:
      'Returns the metrics a suite version published, each with the direction that counts as better. Use it to pick a valid `sortBy` for the leaderboard: a metric key outside this list is rejected rather than silently ranking every target null.',
    positionals: [],
    flags: [
      {
        name: 'suite',
  ...
  },
  {
    ...
    description:
      'Returns every benchmark suite with published results, along with the suite version the other endpoints default to. Start here: the suite name is a required parameter everywhere else and there is no other way to discover it.',
    positionals: [],
    flags: [],
    hasParams: false,
    paramsAllOptional: true,
  ...
  },
  {
    ...
    description:
      'Returns a target’s published sweep and every one of its aggregate cells: the overall rollup plus a set per condition. Defaults to the current sweep; pass `publicationId` from the history endpoint to read a superseded one, which is how a regression is compared generation to generation. Numbers only — no transcript and no audio.',
    positionals: [
      {
        name: 'target-key',
        paramKey: 'targetKey',
  ...
  },
  {
    ...
    description:
      'Returns every sweep published for a target, newest first, including superseded ones. This is the trend read: it answers "did this model regress?" from Roark’s own published record. Metadata only — pass a row’s `publicationId` to GET /v1/benchmark/target/{targetKey} for that generation’s numbers.',
    positionals: [
      {
        name: 'target-key',
        paramKey: 'targetKey',
  ...
  },
  {
    ...
    description:
      'Returns the individual scored calls behind a target’s aggregate cells, each with the scorer’s rationale — the "why is this number what it is" read. Filter to one cell with `conditionKey` and `metricKey`. Metrics computed without a rationale (latencies, counts) contribute no samples. Returns reasoning only: no transcript and no audio.',
    positionals: [
      {
        name: 'target-key',
        paramKey: 'targetKey',
  ...
  {
    commandPath: ['call', 'tool-invocation', 'append'],
    clientProperty: 'call',
    methodName: 'appendToolInvocations',
    httpMethod: 'post',
  ...
  {
    commandPath: ['customer-flow', 'duplicate'],
    clientProperty: 'customerFlow',
    methodName: 'duplicate',
    httpMethod: 'post',
    httpPath: '/v1/customer-flow/{flowId}/duplicate',
    summary: 'Duplicate a customer flow',
    description:
      "Deep-copies a flow into a new project-owned flow. The copy carries the source's description, branching mode, linked agents, flow-level expectations and flow-owned metrics. A scripted flow copies its whole step graph; an improv flow copies its variants (personas, briefs, expectations). Duplicating a Roark-managed flow is how you customise it. Voicemail flows are Roark-managed and cannot be duplicated.",
    positionals: [
      {
        name: 'flow-id',
        paramKey: 'flowId',
    ...
    flags: [
      ...
      },
      {
        ...
        required: false,
        description:
          "Agents to link on the copy. Omit to carry the source flow's agents over. Required when the source is a Roark-managed flow with no agents of its own.",
        valueKind: 'array',
        repeatable: true,
      },
    ],
  ...
  },
  {
    ...
    flags: [
      ...
      },
      {
        ...
        valueKind: 'string',
        enumValues: ['LOOSE', 'STRICT'],
        repeatable: false,
      },
      {
        name: 'off-script-policy',
        path: ['offScriptPolicy'],
        location: 'body',
        required: false,
        description:
      ...
      {
        name: 'off-script-policy.reaction',
        path: ['offScriptPolicy', 'reaction'],
        location: 'body',
        required: true,
        valueKind: 'string',
        enumValues: ['STAY_SILENT', 'REPEAT', 'RESPOND', 'SAY'],
        repeatable: false,
      },
      {
        name: 'off-script-policy.say-line',
        path: ['offScriptPolicy', 'sayLine'],
        location: 'body',
        required: false,
        valueKind: 'string',
        repeatable: false,
      ...
      {
        name: 'off-script-policy.max-attempts',
        path: ['offScriptPolicy', 'maxAttempts'],
        location: 'body',
        required: true,
        valueKind: 'integer',
        repeatable: false,
      ...
      {
        name: 'off-script-policy.then',
        path: ['offScriptPolicy', 'then'],
        location: 'body',
        required: true,
        valueKind: 'string',
      ...
      {
        name: 'off-script-policy.wait-seconds',
        path: ['offScriptPolicy', 'waitSeconds'],
        location: 'body',
        required: false,
        valueKind: 'integer',
        repeatable: false,
  ...
  {
    commandPath: ['metric', 'definition', 'update'],
    clientProperty: 'metric',
    ...
    flags: [
      ...
      {
        name: 'boolean-true-label',
        path: ['booleanTrueLabel'],
        location: 'body',
        required: false,
      ...
      {
        name: 'boolean-false-label',
        path: ['booleanFalseLabel'],
        location: 'body',
        required: false,
      ...
      },
      {
        ...
        path: ['classificationOptions'],
        location: 'body',
        required: false,
        description: 'Replacement set of classification options (CLASSIFICATION output only)',
        valueKind: 'array',
        repeatable: false,
      },
      {
        name: 'max-classifications',
        path: ['maxClassifications'],
        location: 'body',
        required: false,
      ...
      {
        name: 'tool-definition-ids',
        path: ['toolDefinitionIds'],
        location: 'body',
        required: false,
        description:
      ...
      {
        name: 'supports-multiple-variants',
        path: ['supportsMultipleVariants'],
        location: 'body',
        required: false,
        valueKind: 'string',
        repeatable: false,
      ...
      {
        name: 'analysis-package-id',
        path: ['analysisPackageId'],
        location: 'body',
        required: false,
        valueKind: 'string',
        repeatable: false,
  ...
  {
    commandPath: ['metric', 'variant', 'create'],
    clientProperty: 'metricVariant',
    methodName: 'create',
    httpMethod: 'post',
    httpPath: '/v1/metric/definitions/{idOrSlug}/variants',
    summary: 'Create a metric variant',
    description:
      'Add a configuration of this metric for your organization, seeded from its Default. Edit it with PUT to change what it measures, then pin it where you want it used. Threshold metrics have no variants: their configuration comes from the metric they derive from. Metrics in a package that manages its own variants reject this too.',
    positionals: [
      {
        name: 'id-or-slug',
        paramKey: 'idOrSlug',
  ...
  {
    commandPath: ['metric', 'variant', 'delete'],
    clientProperty: 'metricVariant',
    methodName: 'delete',
    httpMethod: 'delete',
    httpPath: '/v1/metric/definitions/{idOrSlug}/variants/{variantId}',
    summary: 'Delete a metric variant',
    description:
      'Remove one of your organization’s variants. Anything pinned to it falls back to the Default, so deleting a fork of a Roark variant returns you to Roark’s configuration. Roark’s own variants cannot be deleted, and neither can a Default. Values already collected under the deleted variant are retained.',
    positionals: [
      {
        name: 'id-or-slug',
        paramKey: 'idOrSlug',
  ...
  {
    commandPath: ['metric', 'variant', 'get'],
    clientProperty: 'metricVariant',
    methodName: 'getByID',
    httpMethod: 'get',
    httpPath: '/v1/metric/definitions/{idOrSlug}/variants/{variantId}',
    summary: 'Get a metric variant',
    description: 'One configuration of this metric, by id.',
    positionals: [
      {
        name: 'id-or-slug',
        paramKey: 'idOrSlug',
  ...
  {
    commandPath: ['metric', 'variant', 'list'],
    clientProperty: 'metricVariant',
    methodName: 'list',
    httpMethod: 'get',
    httpPath: '/v1/metric/definitions/{idOrSlug}/variants',
    summary: 'List a metric’s variants',
    description:
      'Every configuration of this metric your organization can use: Roark’s own variants and any your organization has added or forked. `isDefault` marks the one the metric is scored with when nothing pins another; pass any variant’s `id` as `sourceVariantId` to pin it on a derived metric. Auto-managed variants (the ones a package materializes for you) are not listed: they are engine state, not configuration you author.',
    positionals: [
      {
        name: 'id-or-slug',
        paramKey: 'idOrSlug',
  ...
  {
    commandPath: ['metric', 'variant', 'update'],
    clientProperty: 'metricVariant',
    methodName: 'update',
    httpMethod: 'put',
    httpPath: '/v1/metric/definitions/{idOrSlug}/variants/{variantId}',
    summary: 'Update a metric variant',
    description:
      'Rename a variant, change its configuration, or both. Every configuration change creates a new immutable version and advances `versionId`; the response carries the advanced value. **Editing one of Roark’s own variants forks it for your organization.** The response carries the new variant’s `id`, which will differ from the one in the path, and `isSystem` becomes false. Roark’s variant is untouched and other organizations keep it. DELETE your fork to go back to it. Which fields are editable depends on the metric: some Roark metrics lock their prompt or output configuration, and a locked field is rejected rather than ignored.',
    positionals: [
      {
        name: 'id-or-slug',
        paramKey: 'idOrSlug',
    ...
    flags: [
      ...
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'The rubric this variant applies. LLM judge metrics only.',
        valueKind: 'string',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Scale minimum. SCALE output only.',
        valueKind: 'integer',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Scale maximum. SCALE output only.',
        valueKind: 'integer',
        repeatable: false,
      },
      {
      ...
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Maximum classifications returned. CLASSIFICATION output only.',
        valueKind: 'integer',
        repeatable: false,
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Free-text audit note recorded on the new version.',
        valueKind: 'string',
        repeatable: false,
      },
    ],
  ...
  {
    commandPath: ['simulation', 'environment', 'create'],
    ...
    flags: [
      {
        ...
        location: 'body',
        required: true,
        description: 'Display name, shown wherever a flow variant references the environment',
        valueKind: 'string',
        repeatable: false,
      },
      {
      ...
      },
      {
        ...
        location: 'body',
        required: true,
        description: 'The noise bed played underneath the simulated caller. NONE plays nothing.',
        valueKind: 'string',
        enumValues: [
          'NONE',
          'AIRPORT',
      ...
      {
        name: 'background-noise-volume',
        path: ['backgroundNoiseVolume'],
        location: 'body',
        required: false,
        description:
  ...
  {
    commandPath: ['simulation', 'environment', 'delete'],
    clientProperty: 'simulationEnvironment',
    methodName: 'delete',
    httpMethod: 'delete',
    ...
    description:
      "Soft-deletes one of the project's environments. It disappears from reads and cannot be picked for new runs; runs already built keep their snapshot. Refused (409) while a live customer flow variant still uses it: move those variants first. Roark-curated environments cannot be deleted (403).",
    positionals: [
      {
        name: 'environment-id',
  ...
  {
    commandPath: ['simulation', 'environment', 'update'],
    clientProperty: 'simulationEnvironment',
    methodName: 'update',
    httpMethod: 'put',
    httpPath: '/v1/simulation/environment/{environmentId}',
    ...
    description:
      "Updates one of the project's environments. Only the fields sent are changed. Runs already built keep the snapshot they were built with. Roark-curated environments cannot be edited (403).",
    positionals: [
      {
        name: 'environment-id',
        paramKey: 'environmentId',
  ...
  {
    commandPath: ['simulation', 'job', 'tool-mock', 'list'],
    clientProperty: 'simulationJobToolMock',
    methodName: 'list',
    httpMethod: 'get',
  ...
  },
  {
    ...
    flags: [
      ...
      },
      {
        ...
        required: false,
        description:
          'Deprecated and inert: it no longer affects the call. It set how long the persona waited once the agent stopped talking, and measured across production simulations it moved the reply gap by less than the noise floor, because model and speech latency dominate it. Every persona now uses one voice-activity profile. Use `interruption` for a caller who talks over the agent. Still accepted and stored so existing clients keep working. BARGE_IN is stored as `responseTiming: QUICK` with `interruption: OCCASIONAL`.',
        valueKind: 'string',
      ...
      },
      {
        ...
        required: false,
        description:
          'How much the persona talks over the agent. Defaults to OFF, a caller that waits its turn.',
        valueKind: 'string',
        enumValues: ['OFF', 'BACKCHANNEL', 'OCCASIONAL', 'HEAVY'],
        repeatable: false,
      },
      {
  ...
  },
  {
    ...
    flags: [
      ...
      },
      {
        ...
        required: false,
        description:
          'How much the persona talks over the agent while it is still speaking. OFF waits its turn. BACKCHANNEL makes listening noises ("mm-hm") over the agent without taking the floor, which tests whether the agent wrongly stops for them. OCCASIONAL adds cutting in on some long agent turns, HEAVY on most of them. Timing is randomised per turn, so two runs of the same persona do not interrupt at identical moments.',
        valueKind: 'string',
        enumValues: ['OFF', 'BACKCHANNEL', 'OCCASIONAL', 'HEAVY'],
        repeatable: false,
      },
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'include-flow-metrics',
        path: ['includeFlowMetrics'],
        location: 'body',
        required: false,
        description:
  ...
  },
  {
    ...
    description:
      'Stops a run that has not finished yet. Already-finished runs are left alone. Intended for CI: when a pipeline is cancelled or superseded, cancelling the run stops it placing calls you no longer need. Safe to call more than once.',
    positionals: [
      {
        name: 'job-id',
        paramKey: 'jobId',
  ...
  {
    commandPath: ['simulation', 'template', 'list'],
    clientProperty: 'simulationTemplate',
    methodName: 'list',
    httpMethod: 'get',
    httpPath: '/v1/simulation/template',
    summary: 'List simulation templates',
    description:
      'Returns the built-in simulation templates, each resolved against this project: the metric and check definitions it collects, and the flows it runs with the variants it covers. A template is a preset rather than a stored object, so building a run from one produces an ordinary run plan you own and can edit afterwards. Pass a `slug` as `template` to POST /v1/simulation/run. Every entry is complete, so there is no per-template endpoint to follow up with, and the list is a fixed catalogue rather than a paginated one. Only templates a request can actually run are listed.',
    positionals: [],
    flags: [],
    hasParams: false,
    paramsAllOptional: true,
  ...
  {
    commandPath: ['simulation', 'tool', 'mock'],
    clientProperty: 'simulation',
    methodName: 'mockTool',
    httpMethod: 'post',
    ...
    flags: [
      ...
      },
      {
        ...
        location: 'body',
        required: false,
        description: 'Your session or room identifier, echoed back in logs for correlation.',
        valueKind: 'string',
        repeatable: false,
      },
      {
  ...
  {
    commandPath: ['simulation', 'tool-fixture', 'create'],
    clientProperty: 'simulationToolFixture',
    methodName: 'create',
    httpMethod: 'post',
    ...
    flags: [
      ...
      {
        name: 'customer-flow-variant-id',
        path: ['customerFlowVariantId'],
        location: 'body',
        required: false,
        description:
  ...
  {
    commandPath: ['simulation', 'tool-fixture', 'delete'],
    clientProperty: 'simulationToolFixture',
    methodName: 'delete',
    httpMethod: 'delete',
  ...
  {
    commandPath: ['simulation', 'tool-fixture', 'list'],
    clientProperty: 'simulationToolFixture',
    methodName: 'list',
    httpMethod: 'get',
    httpPath: '/v1/simulation/tool-fixture',
    ...
    flags: [
      {
        ...
        location: 'query',
        required: false,
        description: 'Only fixtures for this tool.',
        valueKind: 'string',
        repeatable: false,
      },
    ],
  ...
  {
    commandPath: ['simulation', 'tool-fixture', 'update'],
    clientProperty: 'simulationToolFixture',
    methodName: 'update',
    httpMethod: 'put',
    httpPath: '/v1/simulation/tool-fixture/{fixtureId}',
